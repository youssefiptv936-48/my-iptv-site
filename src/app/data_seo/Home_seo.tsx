      ...
      mainEntity: [
         {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "  يقدم لك اشتراك IPTV يعتمد على سيرفرات مستقرة عالية الأداء، مصممة لضمان سرعة التنقل بين القنوات بدون أي بطء أو انقطاعات.", // <--- هنا اكتب الجواب 0
          },
        },

          {
          "@type": "Question",
          name: "تعرف على باقات اشتراك المتوفرة في IPTVFORJA", // <--- هنا اكتب السؤال 1
          acceptedAnswer: {
            "@type": "Answer",
            text: "سواء كنت تريد اشتراك IPTVFORJA لمدة سنة أو اشتراك لمدة ستة أشهر أو ثلاث أشهر أو شهر في نفس الوقت، ستجد جميع الخيارات جاهزة للاستخدام الفوري", // <--- هنا اكتب الجواب 1
          },
        },

          {
          "@type": "Question",
          name: " IPTVFORJA المتجر الرسمي الذي يضمن لك:", // <--- هنا اكتب السؤال 2
          acceptedAnswer: {
            "@type": "Answer",
            text: "مشاهده من أي دولة …  المغرب السعودية، أوروبا، الخليج، العالم... تفعيل فوري خلال ثوانٍ بدون التزام – وبدون بيانات مصرفية للتجربة المجانية", // <--- هنا اكتب الجواب 2
          },
        },

          {
          "@type": "Question",
          name: "ما الذي يميز جودة البث والتغطية في IPTVFORJA؟", // <--- هنا اكتب السؤال 3
          acceptedAnswer: {
            "@type": "Answer",
            text: "يتميز الاشتراك بسيرفرات فائقة الأداء تضمن سرعة التنقل بين القنوات بدون بطء.",
          },
        },
