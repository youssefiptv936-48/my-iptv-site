    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
         {
          ...
          {
          "@type": "Question",
          name: "هل يوفر IPTVFORJA تغطية عالمية؟", // <--- هنا اكتب السؤال 4
          acceptedAnswer: {
            "@type": "Answer",
            text: "نعم، يمكنك المشاهدة من أي دولة.... مثل المغرب، السعودية، أوروبا والخليج... بدون قيود.", // <--- هنا اكتب الجواب 4
          },
        },

          {
          "@type": "Question",
          name: "هل البث مستقر في IPTVFORJA؟", // <--- هنا اكتب السؤال 5
          acceptedAnswer: {
            "@type": "Answer",
            text: "نعم، البث ثابت ويعمل 24/7 بدون تقطيع.", // <--- هنا اكتب الجواب 5
          },
        },

          {
          "@type": "Question",
          name: "ما هي باقات الاشتراك في IPTVFORJA؟", // <--- هنا اكتب السؤال 6
          acceptedAnswer: {
            "@type": "Answer",
            text: "يوفر باقات متعددة (شهر، 3 أشهر، 6 أشهر، سنة) مع تفعيل فوري خلال ثوانٍ.", // <--- هنا اكتب الجواب 6
          },
        },
