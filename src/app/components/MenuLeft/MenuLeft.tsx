...
export default function Menu_left({
  ...
  return (
    <section className="flex  items-center  relative md:justify-center leading-6  p-2   text-slate-200 md:h-screen ">
      
      {/* 1. قسم الأيقونات أو المحتوى الإضافي */}
      <div className=" lg:w-[48%]       lg:h-full grid grid-cols-2 gap-5  ">
        {children}
      </div>

      {/* 2. قسم النصوص والزر */}
      <div className="  lg:w-[50%]  p-5 text-right">
       <H2red>
        {title}
       </H2red>
          <P>{description}</P> 
